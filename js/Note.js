	...
	propTypes:{
		count: function(props, propName) {
			...
			if (props[propName] > 100) {
				return new Error("Creating" + props[propName] + "notes id rediclous!")
			};
		}
...
React.render(<Board count={30} />, document.getElementById('react-container'));
